...
export default function Home1() {
  ...
  async function getAllData() {
    let res = await fetch(
      `https://newsapi.org/v2/everything?q=bitcoin&apiKey=fc4e457d3ed04906bedb5c22daa200ff`
    );
  ...
  async function getHeading() {
    let api = await fetch(
      "https://newsapi.org/v2/top-headlines?country=us&apiKey=fc4e457d3ed04906bedb5c22daa200ff"
    );
  ...
  return (
    <div>
      <div className="flex">
          ...
          {sliceArr.map((ele) => {
            return (
              <div className="relative h-max lg:col-span-4 md:col-span-6 col-span-12 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                />
                <div className="p-5">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white h-11">
                    {ele.title}
                  </h5>
        ...
        <div
          className="bg-amber-600 p-5"
          style={{ marginTop: "45px", zIndex: "-1" }}
        >
          <h3
            className="bg-amber-600 text-center font-bold text-2xl pb-5 fixed z-30"
            style={{ borderBottom: "2px solid black", width: "315px" }}
          >
            Top Heading
          </h3>
